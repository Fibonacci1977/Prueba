...
| <p>#!/usr/bin/env bash<br>set -euo pipefail<br><br>export DISPLAY=: 0<br><br>echo  "[+] Iniciando Xvfb (pantalla virtual)"<br>Xvfb : 0  -screen  0 1280 x800x24 -nolisten tcp &#x26; sleep  1 echo  "[+] Iniciando escritorio LXDE" dbus-launch --exit- with -session startlxde &#x26; sleep  2 echo  "[+] Iniciando servidor x11vnc" x11vnc -display : 0  -forever -nopw -shared -rfbport  5900  -quiet &#x26; echo  "[+] Iniciando noVNC (proxy websockify)" websockify --web=/usr/share/novnc/  8080  localhost: 5900  &#x26; echo  "[+] Contenedor listo. Manteniéndolo activo..." tail -f /dev/null <br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br></p> |
| ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
...
| <p>FROM ubuntu: 24.04<br><br>ENV DEBIAN_FRONTEND=noninteractive<br># Corrige problemas de renderizado de fuentes en Swing/AWT<br>ENV _JAVA_OPTIONS= "-Dsun.java2d.xrender=false -Dawt.useSystemAAFontSettings=on -Dswing.aatext=true" # Instala Java 8, IcedTea-Web (javaws), LXDE y herramientas de escritorio remoto RUN apt-get update &#x26;&#x26; \    apt-get install -y \        lxde \        xvfb \        x11vnc \        novnc \        websockify \        dbus-x11 \        openjdk -8 -jdk \        icedtea-netx \        libxext6 libxrender1 libxtst6 \        fonts-dejavu-core xfonts-base \        x11-apps \        wget curl nano ca-certificates &#x26;&#x26; \    apt-get clean &#x26;&#x26; rm -rf /var/lib/apt/lists/* # Crear directorio de applets RUN mkdir -p /root/applets WORKDIR /root/applets # Copiar script de inicio COPY start.sh /usr/local/bin/start.sh RUN chmod +x /usr/local/bin/start.sh # Exponer VNC y noVNC EXPOSE  5900 8080 CMD [ "/usr/local/bin/start.sh" ]<br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br> <br><br></p> |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
